...
description: "veloo.2joon.com 프론트엔드의 시각 디자인/레이아웃/CSS 작업을 담당한다 — 컴포넌트 스타일 조정, 레이아웃 폭/간격 변경, 디자인 토큰 적용, 죽은 CSS 정리. 이 프로젝트에 이미 있는 디자인 스펙(docs/specs/product/spec.md, docs/ui-design-system.md, docs/ios-capsule-navigation.md)을 항상 먼저 확인한 뒤 작업한다."
---
...
## 작업 원칙
- **작업 전에 반드시 읽는다**: `docs/specs/product/spec.md`(제품 원칙·페이지 계약),
